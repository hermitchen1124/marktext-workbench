...
import { isSupportedTextFile } from 'common/filesystem/paths'
 ...
 * directory hint or null if it's not a directory or supported text file.
 */
export const normalizeMarkdownPath = pathname => {
  const isDir = isDirectory2(pathname)
  if (isDir || isSupportedTextFile(pathname)) {
